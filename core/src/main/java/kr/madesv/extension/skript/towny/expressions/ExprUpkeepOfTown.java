...
public class ExprUpkeepOfTown extends SimpleExpression<Number> {
    ...
    public String toString(@Nullable Event e, boolean paramBoolean) {
        return "[madesv] [towny] upkeep of town %string%";
    }
    ...
    protected Number[] get(Event e) {
        return new Number[] {
                TownySettings.getTownUpkeepCost(TownyUniverse.getInstance().getTown(town.getSingle(e)))
        };
    }
